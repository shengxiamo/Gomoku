...
// 各个棋型的代号与权重
#define OTHER 0// 其他棋型
#define WIN 1// 白赢，1000000
#define LOSE 2// 白输，-10000000
#define FLEX4 3// 白活4，50000
#define flex4 4// 黑活4，-100000
#define BLOCK4 5// 400
...
public:  // 博弈树搜索部分
    ...
    int analyse(int board[15][15],int depth,int alpha,int beta);// 博弈树极大极小搜索加alpha-beta剪枝
...
private:
    int tuple6type[4][4][4][4][4][4];// 棋型辨识六元组,0无子,1黑子,2白子,3边界
